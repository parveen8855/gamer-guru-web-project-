...
//         message.push("Name must be longer than 2 character");
//     };
//     if (password.value.length < 8) {
//         message.push("password must be longer than 8 characters")
//     }
//     if (pass.value.search("^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,10}$")) {
//         message.push("password must contain one number")
//     }
//     if (password.value.search(/[a-z]/ < 1)) {
//         message.push("password must contain one lower case character")
//     }
//     if (pass.search(/[A-Z]/ < 1)) {
//         message.push("password must contain one upper case character")
//     }
